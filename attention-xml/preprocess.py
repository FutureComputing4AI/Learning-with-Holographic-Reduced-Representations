...
@click.option('--add-spn', type=click.BOOL, default=False, help='Add SPN labels to the dataset.')
def main(text_path, tokenized_path, label_path, vocab_path, emb_path, w2v_model,
         vocab_size, max_len, add_spn):
    ...
    if not os.path.exists(vocab_path):
        ...
        logger.info(F'Embedding Path. {w2v_model}')
